...
# penetration testing only. The developer HackBoltz is not responsible         #
...
cat << EOF
    ...
    ${cyan}[${blue}1${cyan}]${white} YouTube Live TV
    ${cyan}[${blue}2${cyan}]${white} Birthday Wish
    ${cyan}[${blue}3${cyan}]${white} Secret Message
    ${cyan}[${blue}4${cyan}]${white} Fake Instagram Followers
    ${cyan}[${blue}5${cyan}]${white} Chating Bot (Fake AI)
